...
def serialize_list(out, lst, delimiter='', max_length=20):

    """This method is used to serialize list of text
    pieces like ["some='Another'", "blah=124"]
...
def format_value(value):
    ...
    try:
        if isinstance(value, six.binary_type):
            ...
            result = serialize_list('[', values, delimiter=',') + ']'
            ...
            result = serialize_list('{', items, delimiter=',') + '}'
            return force_unicode(result)
