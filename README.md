...
Imago is the webserver that the MSG Staff use to serve content at [https://cdn.mila-software.group](our Content Delivery Network). The server was designed to allow ShareX users to easily and securely upload their screenshots to a fast, well-designed and efficient server.
